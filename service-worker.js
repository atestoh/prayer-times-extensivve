const CACHE_NAME = 'prayer-times-cache-v3'; // Increment version for core app file updates
const urlsToCache = [
    '/',
    '/index.html',
    '/style.css',
    '/script.js',
    '/manifest.json',
    'https://cdn.jsdelivr.net/npm/adhan@5.0.0/dist/adhan.min.js' // Cache the adhan-js library
];
